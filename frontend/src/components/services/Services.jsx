            ...
            <div class="w-full px-4">
              <div class="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
                ...
                <p class="text-body-color text-base">
                  "Discover the wonder of Sri lanka with ease and excitement
                  through our comprehensive travel services. We provide
                  everything you need for the perfect journey and make your
                  travel dreams a reality with our user-friendly platform. Let
                  us be your trusted partner in creating unforgettable travel
                  experiences."
                </p>
              </div>
            </div>
