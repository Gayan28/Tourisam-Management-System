  ...
  return (
    <div className="w-full bg-black py-16 px-10 grid md:grid-cols-2 gap-8 text-gray-300 bottom-0">
      <div className="">
        ...
        <p className="py-4">
          Explore the wonders of Sri Lanka with our curated travel experiences.
          Immerse yourself in the rich culture, breathtaking landscapes, and
          warm hospitality of this tropical paradise. Discover tailor-made
          itineraries, expertly crafted to make your journey unforgettable. Your
          gateway to a vibrant tapestry of history, nature, and adventure
          awaits. Start your Sri Lankan adventure today!
        </p>
